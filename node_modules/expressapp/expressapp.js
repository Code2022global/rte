...
module.exports = class methods {
  ...
  application() {
    ...
    let initMethods = ref.options.initMethods;
    ...
    ref.server = ref.app.listen(ref.options.properties.portNumber, function() {
      console.log('server listening at ' + ref.options.properties.portNumber);
    });
    ...
    if (initMethods) {
      initMethods.forEach(function(r) {
